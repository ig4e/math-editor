...
interface ImportMetaEnv {
  ...
  MODE: string;
  // Vite's `vite/client` declares these as boolean; upstream had them as
  // string (probably from a legacy CRA migration). Align with Vite or
  // truthiness checks short-circuit to `string | boolean`.
  DEV: boolean;
  PROD: boolean;
  SSR: boolean;
  BASE_URL: string;
